...
import { dataProductFilter } from "@/data/data-product-filter";
    ...
    <ContainerContent className="">
      ...
      <div className="flex md:flex-row flex-col justify-between min-h-[1000px] mt-9 gap-[38px]">
        ...
        <div className="flex-1 flex flex-col items-center">
          ...
          {((data?.data && data.data.filterProducts.length <= 0) ||
            !data?.data) && (
            <p className="text-black-main text-lg">No products were found</p>
          )}
        </div>
      </div>
    </ContainerContent>
