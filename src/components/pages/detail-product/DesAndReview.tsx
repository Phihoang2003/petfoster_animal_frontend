...
export default function DesAndReview({
  description,
  reviews,
}: IDesAndReviewProps) {
    ...
    <Box sx={{ width: "100%", mt: "32px", position: "relative" }}>
      <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
        ...
        >
          ...
          <Tab
            label={`Review ( ${toAbbrevNumber(reviews.length)} )`}
            {...a11yProps(1)}
          />
        </AntTabs>
      </Box>
      <CustomTabPanel
        className="text-1xl text-[#374151]"
        value={value}
        index={0}
      >
        ...
        {setshowLoadMore && (
          <div className="text-center mt-11">
            <span
              ...
              className="text-[#727272] text-1xl hover:underline cursor-pointer"
            >
