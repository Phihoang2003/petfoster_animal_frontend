...
export default function ChatMapItem({
  data,
  me,
  options = { size: "sm" },
  avartar,
        ...
        >
          <div
            className={classNames(
              "bg-white shadow-sm w-full relative overflow-hidden flex-1",
              {
                ["order-1"]: me,
                    ...
                    >
                      <Markers
                        ...
                        isShop={
                          ...
                          data.username === contants.usernameAdmin
                        }
