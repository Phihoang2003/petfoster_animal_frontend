...
import OrderPopup from "@/components/pages/chats/components/OrderPopup";
import EmojiPicker from "@/components/common/inputs/EmojiPicker";
import ImageChatItem from "@/components/pages/chats/ImageChatItem";

const MapDialog = dynamic(() => import("../../boxs/maps/MapDialog"), {
  ssr: false,
});
...
export default function ChatFooter({
  ...
  const { location, address } = useAppSelector(
            ...
            <div className="flex items-center gap-2 text-[#ACABAB]">
              <WrapperAnimation
                className={classNames(
                  "py-2 cursor-pointer flex items-center justify-center",
                  {
              ...
              <WrapperAnimation
                ...
                hover={{}}
                className={classNames(
                  "py-2 cursor-pointer flex items-center justify-center pl-2",
                  {
