  ...
  return (
    <div
      ...
      className={classNames(
        "relative overflow-hidden py-[24px] px-[28px] pr-[20px] w-full rounded-xl bg-[#F2F2F2] border-2 transition-all ease-linear select-none ",
        {
          // [styles['check-label']]: true,
          "border-violet-secondary": checked && !disabled,
          "border-transparent": !checked && !disabled,
          "hover:border-violet-secondary cursor-pointer text-black-main":
            !disabled,
