  ...
  return (
    ...
    >
      <div className=" w-full h-fit">
        <figure className="relative w-full h-[300px] md:h-full md:max-h-[420px] rounded-xl overflow-hidden">
          <img
          ...
          return (
            <div
              ...
              className={classNames(
                ...
                {
                  "border-green-main-dark": curImage === index,
                  " border-transparent": curImage !== index,
                }
              )}
            >
              <ImageAnimation
                className=" max-h-[392px] object-cover"
                src={img}
                alt={img}
              />
            </div>
