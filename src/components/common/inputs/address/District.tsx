...
import { IDistrictOutside } from "@/configs/interface";
...
export default function District({
  ...
  const validate = () => {
    ...
    const divisionValidate = Validate.division<IDistrictOutside>(
      value,
      dataBeforeValid,
      "DistrictName"
    );
  ...
  const dataBeforeValid = useMemo(() => {
    ...
    return data.filter((item) => {
      return (
        ...
        (item.NameExtension && item.NameExtension.includes(value.toLowerCase()))
      );
    });
  }, [value, data]);
