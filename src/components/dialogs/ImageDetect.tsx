...
export interface IImageDetectProps {
  ...
  onDragEnter?: () => void;
  onDragEnd?: () => void;
  onDetected?: (data: IMediadetected) => void;
  options?: {
    showClose?: boolean;
  };
}
    ...
    <div className="flex flex-col gap-1 items-center">
      <div
        ...
        className={classNames(
          "w-20 relative select-none aspect-square rounded-lg border-2 flex items-center justify-center text-2xl text-black-main overflow-hidden ",
          {
      ...
      >
        ...
        {options.showClose && (
          <span
            onClick={() => handleCloseImage(data, index)}
            className="absolute top-0 right-0 px-2 text-1xl cursor-pointer text-white"
          >
