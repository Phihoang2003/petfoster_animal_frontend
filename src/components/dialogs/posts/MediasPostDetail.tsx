...
export default function MediasPostDetail({ images }: IMediaPostDetailProps) {
  ...
  const handleMoveTime = () => {
    ...
    const second =
      (parseInt(refTimeLine.current?.value as string) / 100) *
    ...
    <>
      <AnimatePresence initial={false} custom={direction}>
        <div
          ...
          className="sm:hidden md:block flex-1 h-full overflow-hidden relative"
        >
          ...
          {!images[curImage]?.isVideo && (
            <>
              {images.length > 1 && (
                <div className="absolute top-0 inset-x-0 bottom-6 flex items-center justify-center z-30">
              ...
              {images.length > 1 && (
                <div className="absolute bottom-0 flex items-end justify-center gap-[6px] w-full h-full pb-4  ">
                    ...
                    <div className="bg-[rgba(22,24,35,.34)] rotate-[-90deg] w-16 h-6 rounded-[32px] relative flex flex-col overflow-hidden px-2">
                      <div className="w-full h-full flex items-center relative">
                        ...
                        <div
                          ...
                          className="w-[50%] h-[2px] absolute bg-white rounded"
                        ></div>
                      </div>
                    </div>
                  </div>
              ...
              >
                <div className="flex-1 h-full flex items-center relative">
                  <div className="w-full h-full flex items-center relative">
                    ...
                    <div
                      style={{ width: percent + "%" }}
                      className="progress h-[2px] absolute bg-white rounded"
                    ></div>
                  </div>
                </div>
