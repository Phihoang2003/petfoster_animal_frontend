...
export default function PrimaryPostButton({
  ...
  const __VARIANT_NONE_CLASS =
    "bg-[#F6F6F6] text-violet-post-primary border-violet-post-primary font-medium";

  const __VARIANT_FILL_CLASS =
    "bg-violet-post-primary text-white font-semibold";
    ...
    <WrapperAnimation htmlFor={meta.htmlFor} hover={hovers[hover]} className="">
      <CustomButton
        ...
        className={classNames(
          "flex items-center justify-center border gap-2 cursor-pointer",
          {
            [sizes[size]]: true,
