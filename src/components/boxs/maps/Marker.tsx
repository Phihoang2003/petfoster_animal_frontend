      ...
      <div className="drop-shadow-lg">
        <div
          className={classNames(
            "speech down bg-white shadow-lg text-black-main flex flex-col gap-2 relative rounded-xl justify-center items-center",
            {
        ...
        >
          <Avatar
            ...
            src={
              isShop
                ? "/icons/icon-chat-now.svg"
                : (avartar ? avartar : user?.avatar) || contants.avartarDefault
            }
          />
          {option.showName && (
